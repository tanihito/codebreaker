Feature: code-breaker submits guess
  ...
  that muches the number but not the position of a number in the secret code,
  ...
  for each of the exact maches in ther first, third and fourth positions. The
  number match in ther second position would be ignored.
